...
namespace Abp.BlazorWebPrerendering.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update BlazorWebPrerenderingDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update BlazorWebPrerenderingEfCoreEntityExtensionMappings to extend the IdentityUser entity
